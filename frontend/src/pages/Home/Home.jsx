...
import { useContext, useRef, useState } from "react"; // removed useEffect since it's not used
...
// import { getCurrentJobDetails } from "../../api/api"; // Commented out unused import
...
export default function Home() {
  ...
  //   const details1 = await getCurrentJobDetails(1); // Fetch job details for printer 1
  //   const details2 = await getCurrentJobDetails(2); // Fetch job details for printer 2
  //   const details = [details1, details2]; // Combine the details for both printers
  //   setJobDetails(details.filter((detail) => detail !== null)); // Filter out null details
  // };
      ...
      <div className="home-main">
        ...
        <div className="dashboard">
          <div className="db-top">
            <h3>Hey {user?.name || "Guest"}, Welcome to Webprint</h3>
